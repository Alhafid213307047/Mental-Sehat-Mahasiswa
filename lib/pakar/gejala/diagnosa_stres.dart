...
class DiagnosaStres extends StatefulWidget {
  const DiagnosaStres({Key? key}) : super(key: key);

  @override
  _DiagnosaStresState createState() => _DiagnosaStresState();
}

class _DiagnosaStresState extends State<DiagnosaStres> {
  ...
  Future<void> _showTambahGejalaDialog(BuildContext context) async {
    try {
      ...
      _kodeController.text = 'S${_nextKodeSuffix.toString().padLeft(3, '0')}';
    } catch (e) {
      print('Error: $e');
    }
