...
class DepresiDiagnosisResults extends StatefulWidget {
  final int totalScore;
  final List<UserAnswer> userAnswers;

  const DepresiDiagnosisResults({
    required this.totalScore,
    required this.userAnswers,
  });
  
  @override
  State<DepresiDiagnosisResults> createState() => _DepresiDiagnosisResultsState();
}

class _DepresiDiagnosisResultsState extends State<DepresiDiagnosisResults> {
  ...
  String _getSolution() {
    ...
    switch (resultCategory) {
      case "Normal":
        solution = DepresiSolutionData.solutions
            .firstWhere((s) => s.kode == "SD01")
            .value;
        break;
      case "Depresi Ringan":
        solution = DepresiSolutionData.solutions
            .firstWhere((s) => s.kode == "SD02")
            .value;
        break;
      case "Depresi Sedang":
        solution = DepresiSolutionData.solutions
            .firstWhere((s) => s.kode == "SD03")
            .value;
        break;
      case "Depresi Parah":
        solution = DepresiSolutionData.solutions
            .firstWhere((s) => s.kode == "SD04")
            .value;
        break;
      case "Depresi Sangat Parah":
        solution = DepresiSolutionData.solutions
            .firstWhere((s) => s.kode == "SD05")
            .value;
        break;
      default:
        break;
    ...
    return StreamBuilder<ConnectivityResult>(
      ...
      builder: (context, snapshot) {
        if (snapshot.data == ConnectivityResult.none) {
          ...
          return _buildDepresiDiagnosaResult();
        }
      },
    );
  }
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isDataSaved
                            ...
                            : () {
                                _saveDiagnosis('Diagnosa Depresi');
                              },
