...
import 'package:mentalsehat/users/results/kecemasanDiagnosis_result.dart';

class QuestionKecemasan extends StatefulWidget {
  const QuestionKecemasan({super.key});

  @override
  State<QuestionKecemasan> createState() => _QuestionKecemasanState();
}

class _QuestionKecemasanState extends State<QuestionKecemasan> {
  ...
  void _showResultPage() {
    if (_selectedAnswers[_currentQuestion] == null) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => KecemasanDiagnosisResults(
