...
import 'package:mentalsehat/users/results/stresDiagnosis_results.dart';

class QuestionStres extends StatefulWidget {
  @override
  _QuestionStresState createState() => _QuestionStresState();
}

class _QuestionStresState extends State<QuestionStres> {
  ...
  void _showResultPage() {
    if (_selectedAnswers[_currentQuestion] == null) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => StressDiagnosisResults(
